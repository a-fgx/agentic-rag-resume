...
# Load .env before importing app.graph — the OpenAI client reads OPENAI_API_KEY at init
load_dotenv()
...
def main() -> None:
    ...
    try:
        ...
        result = run_graph(question=args.question, mode=args.mode, voice=args.voice)
